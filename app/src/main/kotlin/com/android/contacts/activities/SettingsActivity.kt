...
//            setupMaterialScrollListener(binding.settingsNestedScrollview, binding.settingsAppbar)
    ...
    private fun setupOnContactClick() {
        binding.apply {
            ...
            settingsOnContactClickHolder.setOnClickListener {
                ...
                val blurTarget = findViewById<BlurTarget>(com.goodwy.commons.R.id.mainBlurTarget)
                    ?: throw IllegalStateException("mainBlurTarget not found")
                RadioGroupIconDialog(this@SettingsActivity, items, config.onContactClick, R.string.on_contact_click, blurTarget = blurTarget) {
    ...
    private fun importContacts() {
        val blurTarget = findViewById<BlurTarget>(com.goodwy.commons.R.id.mainBlurTarget)
            ?: throw IllegalStateException("mainBlurTarget not found")
        FilePickerDialog(this, blurTarget = blurTarget) {
